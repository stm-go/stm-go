...
<div class="login-box">
    ...
    <div class="card">
      <div class="card-body login-card-body text-center">
        ...
        <p class="login-box-msg"><?php echo e(__('Faça login para ir ao seu painel de controle.')); ?></p>
        ...
        <form action="<?php echo e(route('admin.auth')); ?>" method="POST">
          ...
          <div class="row">
            <!-- /.col -->
            <div class="col-12">
              <button type="submit" class="btn btn-primary btn-block"><?php echo e(__('Entrar')); ?></button>
            </div>
            <!-- /.col -->
          </div>
        </form>
...
<?php /**PATH /var/www/vhosts/meuprogramador.com.br/stmgo.com.br/core/resources/views/admin/login.blade.php ENDPATH**/ ?>