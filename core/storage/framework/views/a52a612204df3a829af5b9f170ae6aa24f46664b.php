                  ...
                  <div class="col-lg-8">
                    <form  class="" action="<?php echo e(route('admin.user.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Nome" value="<?php echo e(old('name')); ?>">
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                            <div class="form-group">
                              <label for="">Apelido <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <input type="password" class="form-control" name="password" placeholder="Digite uma senha" value="<?php echo e(old('password')); ?>">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group">
                              <label for="">Repita a Senha <span class="text-danger">*</span></label>
                              <input type="password" class="form-control" name="password_confirmation" placeholder="Digite a senha novamente" value="<?php echo e(old('password_confirmation')); ?>">
                            ...
                            <div class="form-group">
                              <label for="">Role <span class="text-danger">*</span></label>
                                <select class="form-control" name="role">
                                    <option value="" selected="" disabled="">Selecione uma Regra</option>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/meuprogramador.com.br/stmgo.com.br/core/resources/views/admin/user/add.blade.php ENDPATH**/ ?>