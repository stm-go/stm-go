<nav class="main-header navbar navbar-expand navbar-light navbar-white">
                  ...
                  <ul class="nav flex-column">
                    <li class="nav-item">
                      <a href="<?php echo e(route('admin.editProfile')); ?>" class="nav-link">
                          <i class="fas fa-edit mr-1"></i> <?php echo e(__('Editar Perfil')); ?> 
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="<?php echo e(route('admin.editPassword')); ?>" class="nav-link">
                          <i class="fas fa-unlock-alt mr-1"></i> <?php echo e(__('Alterar a senha')); ?>

                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="<?php echo e(route('admin.logout')); ?>" class="nav-link">
                          <i class="fas fa-sign-out-alt mr-1"></i> <?php echo e(__('Sair')); ?>
  ...
  </nav><?php /**PATH /var/www/vhosts/meuprogramador.com.br/stmgo.com.br/core/resources/views/admin/partials/top-navbar.blade.php ENDPATH**/ ?>