		...
		<div class="row">
			<div class="col-lg-8">
				<div class="jobdetails-area">
                    ...
                    <div class="j-info">
                        <h4>{{ __('Responsabilidades do trabalho') }}</h4>
                        <p>
                    ...
                    <div class="j-info">
                        <h4>{{ __('Requerimentos educacionais') }}</h4>
                        <p>
                    ...
                    <div class="j-info">
                        <h4>{{ __('Requisitos de experiência') }}</h4>
                        <p>
                    ...
                    <div class="j-info">
                        <h4>{{ __('Requisitos adicionais') }}</h4>
                        <p>
                    ...
                    <div class="j-info">
                        <h4>{{ __('Remuneração & outros Benefícios') }}</h4>
                        <p>
                            {!! $job->other_benefits !!}
                        </p>
                    </div>
                    ...
                    <a href="#" class="main-btn" data-toggle="modal" data-target="#applyjob">{{ __('Candidatar-se ao emprego') }}</a>
                </div>
			...
			<div class="col-lg-4  order-first order-lg-last">
				...
				<div class="widget search-widget">
					<h4 class="widget-title">{{ __('Pesquisar Vagas') }}</h4>
				...
				<div class="widget categories-widget">
                    <h4 class="widget-title">{{ __('Todas as Categorias') }}</h4>
                        <ul>
                            <li >
				  ...
				  <div class="widget social-links">
					<h4 class="widget-title">{{ __('Redes Sociais') }}</h4>
						<ul>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">{{ __('Candidatar-se para esse Trabalho') }}</h5>
        ...
        <form action="{{ route('job.apply.submit') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-body">
            <div class="form-group">
              <input class="form-control" type="text" name="name" value="{{ old('name') }}" placeholder="{{ __('Nome') }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input class="form-control" type="text" name="expected_salary" value="{{ old('expected_salary') }}" placeholder="{{ __('Seu salário esperado') }}">
              </div>

            <div class="form-group">
              <textarea name="message" class="form-control textarea"  placeholder="{{ __('Sua mensagem') }}">{{ old('message') }}</textarea>
            </div>
            <div class="form-group">
          ...
          <div class="modal-footer">
            <button type="submit" class="main-btn">{{ __('Candidatar-se a Vaga') }}</button>
          </div>
        </form>
      </div>
    </div>
