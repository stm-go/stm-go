		...
		<div class="row">
			<div class="col-lg-12">
				<div class="page-title-item text-center">
					<h2 class="title">{{ __('Área do Artigo') }}</h2>
					<ul class="breadcrumb-nav">
						<li class=""><a href="{{ route('front.index') }}">{{ __('Home') }} </a></li>
						<li class=""><a href="{{ route('front.blogs') }}">{{ __('Artigo') }} </a></li>
						<li class="active" aria-current="page">{{ __('Área do Artigo') }}</li>
					</ul>
				</div> <!-- page title -->
			</div>
		</div> <!-- row -->
						...
						<div class="content">
							...
							<div class="blog-details-bar mt-30">
								<div class="blog-social">
									<h4 class="title">{{ __('Compartilhamento Social :') }}</h4>
