				...
				<div class="page-title-item text-center">
					<h2 class="title">{{ __('Artigos') }}</h2>
						<ul class="breadcrumb-nav">
							...
							<li class="active" aria-current="page">{{ __('Artigos') }}</li>
						</ul>
				</div> <!-- page title -->
			</div>
		</div> <!-- row -->
				...
				<div class="blog-standard">
					@if (count($blogs) == 0)
						<div class="col-md-12">
							...
							<h3 class="text-center">{{__('NENHUM ARTIGO ENCONTRADO')}}</h3>
							</div>
						</div>
					@else
					<div class="row">
						...
						<div class="col-md-6 wow fadeInUp" data-wow-delay="0.3s">
							<div class="latest-news-box mb-30">
								...
								<div class="post-content">
									...
									<a href="{{route('front.blogdetails', $item->slug)}}" class="read-more-btn">{{ __('Saiba Mais') }} <i class="fal fa-long-arrow-right"></i></a>
								</div>
							</div>
						</div>
						@endforeach
			...
			<div class="col-lg-4  order-first order-lg-last">
				<div class="blog-sidebar">
					<div class="widget search-widget">
						<h4 class="widget-title">{{ __('Pesquisar Artigos') }}</h4>
					...
					<div class="widget categories-widget">
						<h4 class="widget-title">{{ __('Categorias') }}</h4>
					...
					<div class="widget news-feed-widget">
						<h4 class="widget-title">{{ __('Últimas Notícias') }}</h4>
					...
					<div class="widget tags-widget">
						<h4 class="widget-title">{{ __('Arquivo') }}</h4>
						<ul>
