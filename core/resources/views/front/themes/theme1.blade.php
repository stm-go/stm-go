                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="input-group mt-30">
                                            <input type="text" placeholder="{{ __('Full Name Here') }}" name="name" required>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-group mt-30">
                                            <input type="email" placeholder="{{ __('Email Here') }}" name="email" required>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-group mt-30">
                                            <input type="text" placeholder="{{ __('Phone No') }}" name="phone" required>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-group textarea-group mt-30">
                                            <textarea name="message" id="#" cols="30" rows="10" placeholder="{{ __('Message Us') }}"required></textarea>
