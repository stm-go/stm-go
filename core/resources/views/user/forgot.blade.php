            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-title-item text-center">
                        <h2 class="title">{{ __('Resetar Senha') }}</h2>
                            <ul class="breadcrumb-nav">
                                <li class=""><a href="{{ route('front.index') }}">{{ __('Home') }} </a></li>
                                <li class="active" aria-current="page">{{ __('Resetar Senha') }}</li>
                            </ul>
                    </div> <!-- page title -->
                </div>
            </div> <!-- row -->
        ...
        <div class="row justify-content-center">
            ...
            <div class="sign-form">
                ...
                <form class="" action="{{ route('user.forgot.submit') }}" method="POST">
                    ...
                    <p class="reg-text text-center mb-0"> Voltar para  <a href="{{route('user.login')}}">Login</a></p>
                </form>
            </div>
            </div>
        </div>
