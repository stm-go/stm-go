                        ...
                        <div class="sign-form">
                            ...
                            <form class="" action="{{ route('user.login.submit') }}" method="POST">
                                ...
                                <div class="input-group">
                                    <input class="" type="email" value="{{ old('email') }}" name="email" placeholder="{{ __('Enter Email') }}" required>
                                    @if($errors->has('email'))
                                ...
                                <div class="input-group">
                                    <input class="" type="password" name="password" placeholder="{{ __('Enter Password') }}" required>
