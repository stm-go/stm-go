                        ...
                        <div class="row">
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <input type="password" class="form-control" name="password" placeholder="Digite uma senha" value="{{ old('password') }}">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <input type="password" class="form-control" name="password_confirmation" placeholder="Digite a senha novamente" value="{{ old('password_confirmation') }}">
