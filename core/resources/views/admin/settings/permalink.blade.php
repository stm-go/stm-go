                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="alert alert-primary d-flex align-items-center" role="alert">
                                        ...
                                        <div class="ml-3">
                                            Você pode mudar seu Slug principal.Assim seu Slug mudará no Frontend.
                                        </div>
                                      </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label  class="d-block control-label">Nome da Página : Sobre</label>
                                            <div class="d-block">
                                                <input class="form-control" name="about_slug" value="{{ $permalink->about_slug }}">
                                                <span class="text-info mt-1 d-block">Rota : {{ url('/') }}/{{ $permalink->about_slug }}</span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label  class="d-block control-label">Nome da Página : Serviços</label>
                                            <div class="d-block">
                                                <input class="form-control" name="service_slug" value="{{ $permalink->service_slug }}">
                                                <span class="text-info mt-1 d-block">Rota : {{ url('/') }}/{{ $permalink->service_slug }}</span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label  class="d-block control-label">Nome da Página : Portfolio</label>
                                            <div class="d-block">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label  class="d-block control-label">Nome da Página : Pacotes</label>
                                            <div class="d-block">
                                                <input class="form-control" name="package_slug" value="{{ $permalink->package_slug }}">
                                                <span class="text-info mt-1 d-block">Rota : {{ url('/') }}/{{ $permalink->package_slug }}</span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label  class="d-block control-label">Nome da Página : Equipe</label>
                                            <div class="d-block">
                                                <input class="form-control" name="team_slug" value="{{ $permalink->team_slug }}">
                                                <span class="text-info mt-1 d-block">Rota : {{ url('/') }}/{{ $permalink->team_slug }}</span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label  class="d-block control-label">Nome da Página : FAQ</label>
                                            <div class="d-block">
                                                <input class="form-control" name="faq_slug" value="{{ $permalink->faq_slug }}">
                                                <span class="text-info mt-1 d-block">Rota : {{ url('/') }}/{{ $permalink->faq_slug }}</span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label  class="d-block control-label">Nome da Página : Carreiras</label>
                                            <div class="d-block">
                                                <input class="form-control" name="gallery_slug" value="{{ $permalink->gallery_slug }}">
                                                <span class="text-info mt-1 d-block">Rota : {{ url('/') }}/{{ $permalink->gallery_slug }}</span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label  class="d-block control-label">Nome da Página : Vagas</label>
                                            <div class="d-block">
                                                <input class="form-control" name="career_slug" value="{{ $permalink->career_slug }}">
                                                <span class="text-info mt-1 d-block">Rota : {{ url('/') }}/{{ $permalink->career_slug }}</span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label  class="d-block control-label">Nome da Página : Blog</label>
                                            <div class="d-block">
                                                <input class="form-control" name="blog_slug" value="{{ $permalink->blog_slug }}">
                                                <span class="text-info mt-1 d-block">Rota : {{ url('/') }}/{{ $permalink->blog_slug }}</span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label  class="d-block control-label">Nome da Página : Produto</label>
                                            <div class="d-block">
                                                <input class="form-control" name="product_slug" value="{{ $permalink->product_slug }}">
                                                <span class="text-info mt-1 d-block">Rota : {{ url('/') }}/{{ $permalink->product_slug }}</span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label  class="d-block control-label">Nome da Página : Contato</label>
                                            <div class="d-block">
                                                <input class="form-control" name="contact_slug" value="{{ $permalink->contact_slug }}">
                                                <span class="text-info mt-1 d-block">Rota : {{ url('/') }}/{{ $permalink->contact_slug }}</span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label  class="d-block control-label">Nome da Página : LGPD</label>
                                            <div class="d-block">
                                                <input class="form-control" name="quote_slug" value="{{ $permalink->quote_slug }}">
                                                <span class="text-info mt-1 d-block">Rota : {{ url('/') }}/{{ $permalink->quote_slug }}</span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label  class="d-block control-label">Nome da Página : Carrinho</label>
                                            <div class="d-block">
                                                <input class="form-control" name="cart_slug" value="{{ $permalink->cart_slug }}">
                                                <span class="text-info mt-1 d-block">Rota : {{ url('/') }}/{{ $permalink->cart_slug }}</span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label  class="d-block control-label">Nome da Página : Checkout</label>
                                            <div class="d-block">
                                                <input class="form-control" name="checkout_slug" value="{{ $permalink->checkout_slug }}">
                                                <span class="text-info mt-1 d-block">Rota : {{ url('/') }}/{{ $permalink->checkout_slug }}</span>
