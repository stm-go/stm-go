                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin.commonsetting.updateScripts') }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="checkbox" {{ $visibility->is_tawk_to == '1' ? 'checked' : '' }} data-size="large" name="is_tawk_to" data-bootstrap-switch data-off-color="danger" data-on-color="success" data-on-text="Ativo" data-label-text="<i class='fas fa-mouse'></i>"  data-off-text="Desativado">
                            ...
                            <div class="form-group row mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="checkbox" {{ $visibility->is_messenger == '1' ? 'checked' : '' }} data-size="large" name="is_messenger" data-bootstrap-switch data-off-color="danger" data-on-color="success" data-on-text="Ativo" data-label-text="<i class='fas fa-mouse'></i>"  data-off-text="Desativado">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="checkbox" {{ $visibility->is_google_analytics == '1' ? 'checked' : '' }} data-size="large" name="is_google_analytics" data-bootstrap-switch data-off-color="danger" data-on-color="success" data-on-text="Ativo" data-label-text="<i class='fas fa-mouse'></i>"  data-off-text="Desativado">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="checkbox" {{ $visibility->is_recaptcha == '1' ? 'checked' : '' }} data-size="large" name="is_recaptcha" data-bootstrap-switch data-off-color="danger" data-on-color="success" data-on-text="Ativo" data-label-text="<i class='fas fa-mouse'></i>"  data-off-text="Desativado">
                            ...
                            <div class="form-group row mt-5">
                                ...
                                <div class="col-sm-10">
                                        <input type="checkbox" {{ $visibility->is_disqus == '1' ? 'checked' : '' }} data-size="large" name="is_disqus" data-bootstrap-switch data-off-color="danger" data-on-color="success" data-on-text="Ativo" data-label-text="<i class='fas fa-mouse'></i>"  data-off-text="Desativado">
                            ...
                            {{-- <div class="form-group row  mt-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="checkbox" {{ $commonsetting->is_analytics == '1' ? 'checked' : '' }} data-size="large" name="is_analytics" data-bootstrap-switch data-off-color="danger" data-on-color="success" data-on-text="Ativo" data-label-text="<i class='fas fa-mouse'></i>"  data-off-text="Desativado">
