                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.job.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 control-label">{{ __('Linguagem') }}<span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group row">
                                        <label for="title" class="col-sm-2 control-label">{{ __('Titulo') }}<span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group row">
                                        <label for="category_id" class="col-sm-2 control-label">{{ __('Categoria') }}<span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group row">
                                        <label for="position" class="col-sm-2 control-label">{{ __('Posição de Trabalho') }}<span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group row">
                                        <label for="company_name" class="col-sm-2 control-label">{{ __('Empresa') }}<span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group row">
                                        <label for="vacancy" class="col-sm-2 control-label">{{ __('Vaga') }}<span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group row">
                                        <label for="job_responsibility" class="col-sm-2 control-label">{{ __('Responsabilidade de trabalho') }}<span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group row">
                                        <label for="job_context" class="col-sm-2 control-label">{{ __('Contexto de trabalho') }}</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label for="education_requirement" class="col-sm-2 control-label">{{ __('Requerimentos') }}</label>
                                    ...
                                    <div class="form-group row">
                                        <label for="experience_requirement" class="col-sm-2 control-label">{{ __('Experiência') }}</label>
                                    ...
                                    <div class="form-group row">
                                        <label for="additional_requirement" class="col-sm-2 control-label">{{ __('Requisitos adicionais') }}</label>
                                    ...
                                    <div class="form-group row">
                                        <label for="employment_status" class="col-sm-2 control-label">{{ __('Situação de emprego') }}<span class="text-danger">*</span></label>

                                        <div class="col-sm-10">
                                            <select name="employment_status" class="form-control">
                                                <option selected="" value="Full-Time">{{__('Tempo total')}}</option>
                                                <option value="Part-Time">{{__('Tempo parcial')}}</option>
                                                <option value="Project Based">{{__('Baseado em projeto')}}</option>
                                            </select>
                                            @if ($errors->has('employment_status'))
                                                <p class="text-danger"> {{ $errors->first('Situação de emprego') }} </p>
                                            @endif
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="job_location" class="col-sm-2 control-label">{{ __('Local de trabalho') }} <span class="text-danger">*</span></label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="job_location" placeholder="{{ __('Job Location') }}" value="{{ old('job_location') }}">
                                            @if ($errors->has('job_location'))
                                                <p class="text-danger"> {{ $errors->first('Local de trabalho') }} </p>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="other_benefits" class="col-sm-2 control-label">{{ __('Remuneração e outros benefícios') }}</label>
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            @if ($errors->has('content'))
                                                <p class="text-danger"> {{ $errors->first('outros benefícios') }} </p>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="salary" class="col-sm-2 control-label">{{ __('Salário') }}<span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <option value="0" selected>{{ __('Cancelar publicação') }}</option>
                                            <option value="1">{{ __('Publicar') }}</option>
                                            </select>
