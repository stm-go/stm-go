...
@section('content')
   ...
   <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">{{ __('Bem-vindo,') }} {{ Auth::guard('admin')->user()->name }} !</h1>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
         ...
         <div class="row">
          <!--<div class="col-md-4 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">{{ __('Produtos') }}</span>
          ...
          <!--<div class="col-md-4 col-sm-6 col-12">
            <div class="info-box">
              ...
              @endphp
              <div class="info-box-content">
                <span class="info-box-text">{{ __('Pedidos Pendentes') }}</span>
              ...
              <div class="col-md-4 col-sm-6 col-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">{{ __('Artigos') }}</span>
              ...
              <div class="col-md-4 col-sm-6 col-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">{{ __('Vagas') }}</span>
              ...
              <div class="col-md-4 col-sm-6 col-12">
                <div class="info-box">
                  ...
                  @endphp
                  <div class="info-box-content">
                    <span class="info-box-text">{{ __('Vagas preenchidas') }}</span>
              ...
              <div class="col-md-4 col-sm-6 col-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">{{ __('Serviços') }}</span>
              ...
              <div class="col-md-4 col-sm-6 col-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">{{ __('Equipe') }}</span>
              ...
              <div class="col-md-4 col-sm-6 col-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">{{ __('LGPD') }}</span>
              ...
              <div class="col-md-4 col-sm-6 col-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">{{ __('Projetos') }}</span>
              ...
              <!--<div class="col-md-4 col-sm-6 col-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">{{ __('Galeria') }}</span>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-primary card-outline">
                ...
                <h3 class="card-title">{{ __('Últimos Chamados:') }}
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                <table id="idtable" class="table table-bordered table-striped data_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="mailto:{{ $quote->email }}" class="btn btn-primary btn-sm"><i class="fas fa-paper-plane"></i> {{ __('Enviar') }}</a>
                            </td> 
                         
                            <td>
                                <a class="btn btn-info btn-sm" href="{{ route('admin.quote.details', $quote->id) }}" ><i class="fas fa-eye"></i>{{ __('Detalhes') }}</a>
          ...
          <div class="col-md-6">
            <div class="card card-primary card-outline">
                <div class="card-header">
                <h3 class="card-title">{{ __('Últimos Portfólios :') }}</h3>
