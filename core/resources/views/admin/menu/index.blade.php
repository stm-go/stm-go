...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Construtor de Menus</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="fas fa-home"></i>Home</a></li>
            <li class="breadcrumb-item">Construtor de Menus</li>
            </ol>
        </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    ...
                    <h3 class="card-title">Construtor de Menus</h3>
                    <div class="card-tools d-flex">
                        <button id="updateMenu" class="btn btn-primary btn-sm mr-4">Atualizar Menu Principal</button>
                    ...
                    <div class="card-body ">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="card">
                                    <div class="card-header">
                                        <h6>Add/Editar/Atualizar Área</h6>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <div id="withUrl">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="target" id="target" class="form-control item-menu">
                                                        <option value="_self">Auto</option>
                                                        <option value="_blank">Em Branco</option>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">{{__('Contato')}}
...
<script>
    ...
    // opções do seletor de ícones
    var iconPickerOptions = {searchText: "Buscar...", labelHeader: "{0}/{1}"};
    // opções de lista classificáveis
    ...
    // Quando o menu é escolhido na lista de menus prontos
