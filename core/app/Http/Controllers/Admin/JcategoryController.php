...
class JcategoryController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $notification = array(
            'messege' => 'Categoria de trabalho adicionada com sucesso!',
            'alert' => 'success'
        );
    ...
    public function delete($id){
        ...
        $notification = array(
            'messege' => 'Categoria de trabalho excluída com sucesso!',
            'alert' => 'success'
        );
        return redirect()->back()->with('notification', $notification);
    }
    ...
    public function update(Request $request, $id){
        ...
        $notification = array(
            'messege' => 'Categoria do trabalho atualizada com sucesso!',
            'alert' => 'success'
        );
