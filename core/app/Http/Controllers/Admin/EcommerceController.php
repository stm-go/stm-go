...
class EcommerceController extends Controller
{
    ...
    public function sliderUpdate(Request $request, $id){
        ...
        $notification = array(
            'messege' => 'Slider atualizado com sucesso!',
            'alert' => 'success'
        );
    ...
    public function sliderDelete($id){
        ...
        $notification = array(
            'messege' => 'Slider deletado com sucesso!',
            'alert' => 'success'
        );
        return redirect()->back()->with('notification', $notification);
    }
    ...
    public function bannerStore(Request $request){
        ...
        if($checkbnanner->count() == 2){
            $notification = array(
                'messege' => 'Você não pode adicionar mais que dois banners',
                'alert' => 'warning'
            );
            return redirect()->back()->with('notification', $notification);
        }
        ...
        $notification = array(
            'messege' => 'Banner adicionado com sucesso!',
            'alert' => 'success'
        );
        return redirect()->back()->with('notification', $notification);
    }
    ...
    public function bannerUpdate(Request $request, $id){
        ...
        $notification = array(
            'messege' => 'Banner atualizado com sucesso!',
            'alert' => 'success'
        );
