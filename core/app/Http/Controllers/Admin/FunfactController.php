...
class FunfactController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if($c->count() >= 4){
            $notification = array(
                'messege' => 'Você não pode adicionar mais de quatro',
                'alert' => 'warning'
            );
        ...
        $notification = array(
            'messege' => 'Contador adicionado com sucesso!',
            'alert' => 'success'
        );
        return redirect()->back()->with('notification', $notification);
    }
    ...
    public function update(Request $request, $id){
        ...
        $notification = array(
            'messege' => 'Contador atualizado com sucesso!',
            'alert' => 'success'
        );
    ...
    public function delete($id){
        ...
        $notification = array(
            'messege' => 'Contador deletado com sucesso!',
            'alert' => 'success'
        );
        return redirect()->back()->with('notification', $notification);
    }
    ...
    public function funfactcontent(Request $request, $id){
        ...
        $notification = array(
            'messege' => 'Conteúdo Curiosidades atualizado com sucesso!',
            'alert' => 'success'
        );
