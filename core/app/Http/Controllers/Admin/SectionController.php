...
{   
    ...
    public function w_w_a_update(Request $request, $id){
        ...
        $notification = array(
            'messege' => 'Seção Quem somos Nós Atualizada com sucesso!',
            'alert' => 'success'
        );
    ...
    public function about_section_update(Request $request, $id){
        ...
        $notification = array(
            'messege' => 'Seção Sobre Atualizada com sucesso!',
            'alert' => 'success'
        );
    ...
    public function intro_video_update(Request $request, $id){
        ...
        $notification = array(
            'messege' => 'Seção de vídeo do Intro atualizada com sucesso!',
            'alert' => 'success'
        );
    ...
    public function why_chooseus_update(Request $request, $id){
        ...
        $notification = array(
            'messege' => 'Seção Atualizada com sucesso!',
            'alert' => 'success'
        );
    ...
    public function project_section_update(Request $request, $id){
        ...
        $notification = array(
            'messege' => 'Seção Projeto Atualizada com sucesso!',
            'alert' => 'success'
        );
    ...
    public function team_section_update(Request $request, $id){
        ...
        $notification = array(
            'messege' => 'Seção Equipe Atualizada com sucesso!',
            'alert' => 'success'
        );
    ...
    public function contact_section_update(Request $request, $id){
        ...
        $notification = array(
            'messege' => 'Seção Contato Atualizada com sucesso!',
            'alert' => 'success'
        );
    ...
    public function faq_section_update(Request $request, $id){
        ...
        $notification = array(
            'messege' => 'Seção FAQ Atualizada com sucesso!',
            'alert' => 'success'
        );
    ...
    public function meet_section_update(Request $request, $id){
        ...
        $notification = array(
            'messege' => 'Seção Encontre conosco Atualizada com sucesso!',
            'alert' => 'success'
        );
