...
class HistoryController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $notification = array(
            'messege' => 'Histórico adicionado com sucesso!',
            'alert' => 'success'
        );
    ...
    public function update(Request $request, $id){
        ...
        $notification = array(
            'messege' => 'Histórico atualizado com sucesso!',
            'alert' => 'success'
        );
    ...
    public function delete($id){
        ...
        $notification = array(
            'messege' => 'Histórico excluído com sucesso!',
            'alert' => 'success'
        );
        return redirect()->back()->with('notification', $notification);
    }
    ...
    public function historycontent(Request $request, $id){
        ...
        $notification = array(
            'messege' => 'Conteúdo do histórico atualizado com sucesso!',
            'alert' => 'success'
        );
        return redirect(route('admin.history.index').'?language='.$this->lang->code)->with('notification', $notification);
    }
