...
class SettingController extends Controller
{
   ...
   public function update_theme_version(Request $request) {
      ...
      $notification = array(
         'messege' => $request->theme_version.' versão ativada com sucesso!',
         'alert' => 'success'
     );
    ...
    public function updateSeoinfo(Request $request, $id){
      ...
      $notification = array(
         'messege' => 'SEO Informações atualizadas com sucesso!',
         'alert' => 'success'
     );
   ...
   public function updateScripts(Request $request){
      ...
      $notification = array(
         'messege' => 'Scripts Atualizado com sucesso!',
         'alert' => 'success'
     );
     return redirect()->back()->with('notification', $notification);
   ...
   public function updateBasicinfo(Request $request, $id){
      ...
      $notification = array(
            'messege' => 'Informações básicas atualizadas com sucesso!',
            'alert' => 'success'
        );
...
public function updatepagevisibilityh9(Request $request){
   ...
   public function custom_css_update(Request $request)
   {
       ...
       $notification = array(
         'messege' => 'Estilo personalizado adicionado com sucesso!',
         'alert' => 'success'
     );
     return redirect()->back()->with('notification', $notification);
   }
   ...
   public function update_maintanance(Request $request){
	...
	$notification = array(
		'messege' => 'Modo de manutenção atualizado com sucesso!',
		'alert' => 'success'
	);
	return redirect()->back()->with('notification', $notification);
   ...
   public function update_announcement(Request $request, $id){
	...
	$visibility->save();
	 ...
	 $notification = array(
		   'messege' => 'Informações do anúncio atualizadas com sucesso!',
		   'alert' => 'success'
	   );
   ...
   public function update_preloader(Request $request){
	...
	$notification = array(
		'messege' => 'Pré-carregador atualizado com sucesso!',
		'alert' => 'success'
	);
	return redirect()->back()->with('notification', $notification);
   }
   ...
   public function updatecookie(Request $request, $langid)
   {
       ...
       $notification = array(
         'messege' => 'Alerta de cookie atualizado com sucesso!',
         'alert' => 'success'
     );
     return redirect()->back()->with('notification', $notification);
   }
