...
class GcategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $notification = array(
            'messege' => 'Categoria da galeria adicionada com sucesso!',
            'alert' => 'success'
        );
    ...
    public function delete($id)
    {
        ...
        if($blogs->count() >= 1){
            $notification = array(
                'messege' => 'Primeiro Excluir Galerias Nesta Categoria !',
                'alert' => 'success'
            );
            return redirect()->back()->with('notification', $notification);
        }
        ...
        $notification = array(
            'messege' => 'Categoria da galeria excluída com sucesso!',
            'alert' => 'success'
        );
        return redirect()->back()->with('notification', $notification);
    ...
    public function update(Request $request, $id)
    {
        ...
        $notification = array(
            'messege' => 'Categoria da galeria atualizada com sucesso!',
            'alert' => 'success'
        );
