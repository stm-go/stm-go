...
class CurrencyController extends Controller
{
   ...
   public function __construct()
    ...
    public function store(Request $request)
    {
        ...
        $notification = array(
            'messege' => 'Moeda adicionada com sucesso!',
            'alert' => 'success'
        );
    ...
    public function update(Request $request, $id)
    {
        ...
        $notification = array(
            'messege' => 'Moeda atualizada com sucesso!',
            'alert' => 'success'
        );
    ...
    public function delete($id)
    {
        if($id == 1)
        {
            Session::flash('success', "Você não pode remover a moeda principal.");
            return back();
        }
        ...
        $notification = array(
            'messege' => 'Moeda excluída com sucesso!',
            'alert' => 'success'
        );
        return redirect()->back()->with('notification', $notification);
